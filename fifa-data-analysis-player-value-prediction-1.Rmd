...
Fifa <- read.csv("../input/data.csv",header = T, stringsAsFactors = F)
...
For predicting player value, we ran a correlation between the Value variable and all other variables in the dataset and for running a linear regression model we chose variables which had a correaltion of more than 0.3 
